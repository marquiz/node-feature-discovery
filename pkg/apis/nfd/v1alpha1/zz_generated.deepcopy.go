...
func (in *FeatureRule) DeepCopyInto(out *FeatureRule) {
	*out = *in
	if in.MatchExpressionSet != nil {
		in, out := &in.MatchExpressionSet, &out.MatchExpressionSet
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LegacyRule) DeepCopyInto(out *LegacyRule) {
	*out = *in
	if in.PciID != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LegacyRule.
func (in *LegacyRule) DeepCopy() *LegacyRule {
	if in == nil {
		return nil
	}
	out := new(LegacyRule)
