...
// NfdV1alpha1Client is used to interact with features provided by the nfd.kubernetes.test group.
type NfdV1alpha1Client struct {
	restClient rest.Interface
}

func (c *NfdV1alpha1Client) LabelRules(namespace string) LabelRuleInterface {
	return newLabelRules(c, namespace)
}
