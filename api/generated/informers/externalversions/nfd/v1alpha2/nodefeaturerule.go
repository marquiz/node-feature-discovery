...
type NodeFeatureRuleInformer interface {
	...
	Lister() v1alpha2.NodeFeatureRuleLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NfdV1alpha2().NodeFeatureRules().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NfdV1alpha2().NodeFeatureRules().Watch(context.TODO(), options)
			},
		},
		&nfdv1alpha2.NodeFeatureRule{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *nodeFeatureRuleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&nfdv1alpha2.NodeFeatureRule{}, f.defaultInformer)
}

func (f *nodeFeatureRuleInformer) Lister() v1alpha2.NodeFeatureRuleLister {
	return v1alpha2.NewNodeFeatureRuleLister(f.Informer().GetIndexer())
}
