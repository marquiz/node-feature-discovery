...
import (
	...
	v1alpha2 "sigs.k8s.io/node-feature-discovery/api/generated/listers/nfd/v1alpha2"
	nfdv1alpha2 "sigs.k8s.io/node-feature-discovery/api/nfd/v1alpha2"
)
...
type NodeFeatureGroupInformer interface {
	...
	Lister() v1alpha2.NodeFeatureGroupLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NfdV1alpha2().NodeFeatureGroups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NfdV1alpha2().NodeFeatureGroups(namespace).Watch(context.TODO(), options)
			},
		},
		&nfdv1alpha2.NodeFeatureGroup{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *nodeFeatureGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&nfdv1alpha2.NodeFeatureGroup{}, f.defaultInformer)
}

func (f *nodeFeatureGroupInformer) Lister() v1alpha2.NodeFeatureGroupLister {
	return v1alpha2.NewNodeFeatureGroupLister(f.Informer().GetIndexer())
}
