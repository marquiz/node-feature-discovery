...
type NodeFeatureInformer interface {
	...
	Lister() v1alpha2.NodeFeatureLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NfdV1alpha2().NodeFeatures(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NfdV1alpha2().NodeFeatures(namespace).Watch(context.TODO(), options)
			},
		},
		&nfdv1alpha2.NodeFeature{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *nodeFeatureInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&nfdv1alpha2.NodeFeature{}, f.defaultInformer)
}

func (f *nodeFeatureInformer) Lister() v1alpha2.NodeFeatureLister {
	return v1alpha2.NewNodeFeatureLister(f.Informer().GetIndexer())
}
