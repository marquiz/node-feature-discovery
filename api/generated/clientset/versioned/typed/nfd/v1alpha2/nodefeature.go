...
type NodeFeatureInterface interface {
	Create(ctx context.Context, nodeFeature *v1alpha2.NodeFeature, opts v1.CreateOptions) (*v1alpha2.NodeFeature, error)
	Update(ctx context.Context, nodeFeature *v1alpha2.NodeFeature, opts v1.UpdateOptions) (*v1alpha2.NodeFeature, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha2.NodeFeature, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha2.NodeFeatureList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.NodeFeature, err error)
...
func newNodeFeatures(c *NfdV1alpha2Client, namespace string) *nodeFeatures {
	return &nodeFeatures{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *nodeFeatures) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.NodeFeature, err error) {
	result = &v1alpha2.NodeFeature{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *nodeFeatures) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.NodeFeatureList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha2.NodeFeatureList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("nodefeatures").
...
func (c *nodeFeatures) Create(ctx context.Context, nodeFeature *v1alpha2.NodeFeature, opts v1.CreateOptions) (result *v1alpha2.NodeFeature, err error) {
	result = &v1alpha2.NodeFeature{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("nodefeatures").
...
func (c *nodeFeatures) Update(ctx context.Context, nodeFeature *v1alpha2.NodeFeature, opts v1.UpdateOptions) (result *v1alpha2.NodeFeature, err error) {
	result = &v1alpha2.NodeFeature{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("nodefeatures").
...
func (c *nodeFeatures) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.NodeFeature, err error) {
	result = &v1alpha2.NodeFeature{}
